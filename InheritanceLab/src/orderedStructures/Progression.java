...
public abstract class Progression implements OrderedNumberStructure {
	...
	public boolean isUsedNV() {
		return usedNV;
	}

	public void setUsedNV(boolean usedNV) {
		this.usedNV = usedNV;
	}
	...
	public double NextValue(){
		if (this.isUsedNV()){
			...
			throw new IllegalStateException("nextValue: Invalid argument, no first value.");
		}
